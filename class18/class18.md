...
The National Cancer Institute (NCI) in the US has established the
Genomic Data Commons (or GDC for short) for sharing cancer genomics
data-sets.

This includes data from a range of large scale projects such as The
Cancer Genome Atlas (TCGA) and other projects. The TGCA project aims to
generate comprehensive, multi-dimensional maps of the key genomic
changes in major types and sub-types of cancer.
...
install the following packages “GenomicDataCommons”, “TCGAbiolinks”,
“maftools”)
...
Allign the two sequences and at each index of the mutation, grab 8 amino
acids before and after the mutation.
