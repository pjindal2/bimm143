...
appropriate, and assign the output model to wisc.pr. \#\#\# THESE VALUES
ARE VERY DIFFERENT SO I WILL US SCaLE = TRUE for PCA
...
![](class09_files/figure-gfm/unnamed-chunk-8-1.png)<!-- --> Q4. From
your results, what proportion of the original variance is captured by
the first principal components (PC1)?
